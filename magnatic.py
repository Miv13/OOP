...
for x in arange(-24, 24+4, 4): #tu zmiany analogiczne 16 na 24 17 na 25 32 na 48
    siatka.append(curve(pos=[(x,-24,-24),(x,-24,24)], color=(0,0,1)))
    siatka.append(curve(pos=[(x,24,-24),(x,24,24)], color=(1,0,0)))
for z in arange(-24, 24+4, 4):
    siatka.append(curve(pos=[(-24,-24,z),(24,-24,z)], color=(0,0,1)))
    siatka.append(curve(pos=[(-24,24,z),(24,24,z)], color=(1,0,0)))

biegunN=box(pos=(0,-24,0), axis=(48,0,0), size=(48,.5,48), color=color.blue , opacity = 0.3)
biegunNlbl=label(pos=(24,-24,24), text="N", color=color.blue, opacity=0, height=10)

biegunS=box(pos=(0,24,0), axis=(48,0,0), size=(48,.5,48), color=color.red  , opacity = 0.3)
biegunSlbl=label(pos=(24,24,24), text="S", color=color.red, opacity=0, height=10)
...
warunek=True
while warunek:
    wektor = arrow(pos=(23,-22,23), axis=(0,y,0), color=(1,0.7, 0.7),shaftwidth=0.2) #15 na 23 i analogicznie
